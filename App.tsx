...
// *** COMPONENTE SELECTION GRID (EXTRAÍDO DO APP) ***
// Isso resolve o problema da "tela preta" ao clicar nos menus
...
const App: React.FC = () => {
 ...
 const renderContent = () => {
  ...
  switch (currentPage) {
   ...
   // --- AQUI ESTÁ A CORREÇÃO PRINCIPAL: USANDO O COMPONENTE SELECTIONGRID EXTERNO ---
