...
// Esta função transforma links .m3u8 (rápidos) em .mp4 (download/play)
const getSmartLink = (url: string) => { 
  ...
  // Lógica antiga para Vimeo/Youtube (Player Only)
...
const VideoPlayer: React.FC<{ url: string; title?: string }> = ({ url, title }) => { 
  ...
  // 2. SE FOR ARQUIVO DIRETO (BUNNY / MP4)
